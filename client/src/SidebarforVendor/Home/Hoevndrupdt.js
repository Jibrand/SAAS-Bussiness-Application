...
import Srchbyeml from "../../components/RFQ_Managers/RFQ_Manager/Srchbyeml";
    ...
    <>
      ...
      <main className="main-content">
        ...
        <div className="py-0 conatiner-fluid content-inner mt-n5">
          <Rfqupdatev currentId={currentId} setCurrentId={setCurrentId} />
        </div>
