...
// store
// import {NavbarstyleAction, getDirMode, SchemeDirAction,  getNavbarStyleMode, getSidebarActiveMode, SidebarActiveStyleAction, ModeAction,  SidebarColorAction, getSidebarColorMode, getSidebarTypeMode} from './setting'
            ...
            <aside className="sidebar sidebar-default navs-rounded-all {{ sidebarVariants }}">
                <div className="sidebar-header d-flex align-items-center justify-content-start">
                    <Link to="/dashboard" className="navbar-brand">
                        ...
                        <h4 className="logo-title">Alchimist UI</h4>
                    </Link>
