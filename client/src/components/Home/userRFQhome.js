...
import UserRFQ from '../Form/userRFQ';
...
import UpdatePost from '../Posts/Post/UpdatePost';

const userRFQhome = (props) => {
    ...
    return (
        ...
        <Sidebar />
            <main className="main-content">
                ...
                <UserRFQ currentId={currentId} setCurrentId={setCurrentId} />
