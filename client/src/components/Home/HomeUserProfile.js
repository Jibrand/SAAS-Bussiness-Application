...
import Userprofile from '../../components/RFQ_Managers/RFQ_Manager/UserProfile';

const HomeUpdatePro = (props) => {
    ...
    return (
        ...
        <Sidebar />
            <main className="main-content">
                ...
                <Userprofile currentId={currentId} setCurrentId={setCurrentId} />
